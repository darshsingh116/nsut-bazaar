...
PreferredSize nsutbazaarAppBar(MyTabItem myTabItem, BuildContext context) {
  ...
  return PreferredSize(
    ...
    child: AppBar(
      ...
      (<Widget>[
        (myTabItem.title=="Discover")?(GestureDetector(
            child: Padding(
            ...
            onTap: () => Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => LikedSellProductScreen())))):Container(),
        GestureDetector(
            child: Padding(
            ...
            onTap: () => (myTabItem.title=="Discover")?Navigator.push(context,
                MaterialPageRoute(builder: (context) => AddListingScreen())):Navigator.push(context,
